...
const file1 = path.join(folder1, `${os.type()}-${process.env.EXPECTED_SAVED_ABI_1}.zip`);
const file2 = path.join(folder1, `${os.type()}-${process.env.EXPECTED_SAVED_ABI_2}.zip`);
const file3 = path.join(folder2, `${os.type()}-${process.env.EXPECTED_SAVED_ABI_3}.zip`);
